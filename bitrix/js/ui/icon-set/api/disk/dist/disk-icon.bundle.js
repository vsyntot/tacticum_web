...
(function (exports, ui_iconSet_api_core, main_core) {
	'use strict';
	...
	var diskIcon = Object.freeze({
		__proto__: null,
		BDiskIcon: BDiskIcon,
		DiskIconType: DiskIconType
	});

	exports.DiskIcon = DiskIcon;
	exports.DiskIconType = DiskIconType$1;
	exports.Vue = diskIcon;

})(this.BX.UI.IconSet.Api.Disk = this.BX.UI.IconSet.Api.Disk || {}, BX.UI.IconSet, BX);
