	...
	getContent(): string
	{
		if (this.options.type === PopupType.FINAL)
		{
			return this.options.isRenamedMarket
				? Loc.getMessage('REST_MARKET_EXPIRED_CURTAIN_TRIAL_FINAL_TEXT_BITRIX_GPT_MSGVER_1', this.getCopilotReplacements())
				: Loc.getMessage('REST_MARKET_EXPIRED_CURTAIN_TRIAL_FINAL_TEXT_MARKET_PLUS');
		}

		return this.options.isRenamedMarket
			? Loc.getMessage('REST_MARKET_EXPIRED_CURTAIN_TRIAL_WARNING_TEXT_BITRIX_GPT_MSGVER_1', {
