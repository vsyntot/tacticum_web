...
$MESS["SUPPORT_FAQ_EL_GROUP_SETTINGS"] = "Компонент баптаулары";
$MESS["SUPPORT_FAQ_EL_SETTING_IBLIST"] = "Ақпараттық блок тізімдері";
$MESS["SUPPORT_FAQ_EL_SETTING_IBTYPES"] = "Ақпараттық блок түрлері";
$MESS["SUPPORT_FAQ_EL_SETTING_SECTIONS_LIST"] = "Секцияның ID-і";
