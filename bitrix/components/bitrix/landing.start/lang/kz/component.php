<?php
$MESS["LANDING_CMP_ACCESS_DENIED"] = "Қазіргі уақытта лендингтер қызметі тек портал әкімшілеріне қолжетімді.";
...
$MESS["LANDING_CMP_MODULE_NOT_INSTALLED"] = "Қазіргі уақытта лендингтер қызметі қолжетімсіз.";
$MESS["LANDING_CMP_MODULE_NOT_INSTALLED_CRM"] = "CRM деректерін дайындау мүмкін болмады.";
$MESS["LANDING_CMP_TITLE"] = "Сайттар";
$MESS["LANDING_CMP_TYPE_IS_NOT_ENABLED"] = "Түрге қолдау көрсетілмейді";
