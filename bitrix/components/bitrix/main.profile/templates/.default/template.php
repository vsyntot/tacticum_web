...
<table class="profile-table data-table">
	<tbody>
		<tr>
			<td><?= GetMessage("main_profile_code")?><span class="starrequired">*</span></td>
			<td><input size="30" type="text" name="SMS_CODE" value="<?=htmlspecialcharsbx($arResult["SMS_CODE"])?>" autocomplete="off" /></td>
		</tr>
	</tbody>
</table>

<p><input type="submit" name="code_submit_button" value="<?= GetMessage("main_profile_send")?>" /></p>
...
<?php if($arResult["PHONE_REGISTRATION"]):?>
	<tr>
		<td><?= GetMessage("main_profile_phone_number")?><?php if($arResult["PHONE_REQUIRED"]):?><span class="starrequired">*</span><?php endif?></td>
		<td><input type="text" name="PHONE_NUMBER" maxlength="50" value="<?= $arResult["arUser"]["PHONE_NUMBER"]?>" /></td>
	</tr>
<?php endif?>
...
<?php if($arResult["TIME_ZONE_ENABLED"] == true):?>
	<tr>
		<td colspan="2" class="profile-header"><?= GetMessage("main_profile_time_zones")?></td>
	</tr>
	<tr>
		<td><?= GetMessage("main_profile_time_zones_auto")?></td>
		<td>
...
<table class="data-table profile-table">
	...
	<tbody>
		<tr>
			...
			<td><input type="hidden" name="forum_SHOW_NAME" value="N" /><input type="checkbox" name="forum_SHOW_NAME" value="Y" <?php if ($arResult["arForumUser"]["SHOW_NAME"]=="Y") echo "checked=\"checked\"";?> /></td>
		</tr>
		<tr>
...
<table class="data-table profile-table">
	...
	<tbody>
		...
		<tr>
			...
			<td><textarea cols="30" rows="5" class="typearea" name="blog_INTERESTS"><?= $arResult["arBlogUser"]["INTERESTS"]; ?></textarea></td>
		</tr>
		<tr>
	...
	<table class="data-table profile-table">
		...
		<tbody>
			<tr>
				...
				<td><input type="hidden" name="student_PUBLIC_PROFILE" value="N" /><input type="checkbox" name="student_PUBLIC_PROFILE" value="Y" <?php if ($arResult["arStudent"]["PUBLIC_PROFILE"]=="Y") echo "checked=\"checked\"";?> /></td>
			</tr>
			<tr>
