...
CREATE INDEX ix_b_user_device_user_id_cookable ON b_user_device (USER_ID, COOKABLE);
CREATE INDEX ix_b_user_device_user_id_app_password_id ON b_user_device (USER_ID, APP_PASSWORD_ID);
