...
<?php endif?>
	...
	<tr class="adm-detail-required-field">
		<td class="adm-detail-valign-top"><?= Loc::getMessage("sms_template_edit_sites")?></td>
		<td><?php
	...
	<tr>
		...
		<td>
			<select name="LANGUAGE_ID">
				<option value=""><?= Loc::getMessage("sms_template_edit_not_set")?></option>
				<?php
	...
	<tr class="heading">
		<td colspan="2"><?= Loc::getMessage("sms_template_edit_mess")?></td>
	</tr>
	<tr class="adm-detail-required-field">
...
?>
	<tr>
		<td align="left" colspan="2"><b><?= Loc::getMessage("sms_template_edit_fields")?></b><br><br>
			<?= nl2br($allFields);?></td>
	</tr>
<?php
