...
$MESS["COMPATIBLE_MODE_TIP"] = "Бұл опцияны iblock 17.0.0 нұсқасы шыққанға дейін жасалған компоненттің теңшелген үлгілері үшін орнату қажет. Өнімділікті арттыру үшін компонент үлгісін жаңа пішімге ауыстыру ұсынылады. Толық ақпарат құжаттамада.";
...
$MESS["CP_BCE_SET_VIEWED_IN_COMPONENT"] = "Ескі үлгілер үшін тауарды қарау туралы ақпаратты сақтауды қосу";
...
$MESS["SET_VIEWED_IN_COMPONENT_TIP"] = "Еер қаралған тауарлар туралы ақпарат сақталмаса, бұл опцияны қосу қажет (компонент үлгісі бұл функцияны қолдамайды)";
