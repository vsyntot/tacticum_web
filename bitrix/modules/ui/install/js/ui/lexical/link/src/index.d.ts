 ...
 *
 */
import type { BaseSelection, DOMConversionMap, EditorConfig, LexicalCommand, LexicalNode, NodeKey, RangeSelection, SerializedElementNode } from 'ui.lexical.core';
import { ElementNode, Spread } from 'ui.lexical.core';
