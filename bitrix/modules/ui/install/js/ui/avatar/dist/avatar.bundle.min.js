this.BX=this.BX||{};(function(t,e){"use strict";class i{constructor(t){this.options={...this.getDefaultOptions(),...e.Type.isPlainObject(t)?t:{}};this.node={avatar:null,initials:null,svgUserPic:null,svgMask:null,svgDefaultUserPic:null};this.events=null;this.title=null;this.userName=this.options.userName??this.title;this.initials=e.Type.isString(this.options.initials)?this.options.initials:null;this.picPath=null;this.userpicPath=e.Type.isString(this.options.userpicPath)??this.picPath;this.unicId=null;this.events={};this.size=null;this.baseColor=null;this.borderColor=null;this.borderInnerColor=null;this.setMask();this.setBaseColor(this.options.baseColor);this.setBorderColor(this.options.borderColor);this.setBorderInnerColor(this.options.borderInnerColor);this.setTitle(this.options.title??this.options.userName);if(this.initials){this.setInitials(this.initials)}this.setSize(this.options.size);this.setPic(this.options.picPath??this.options.userpicPath);this.setEvents(this.options.events);if(!this.title&&!this.initials&&!this.picPath){this.setDefaultUserPic()}}setEvents(t){if(e.Type.isObject(t)){this.events=t;const i=Object.keys(this.events);for(const t of i){e.Event.bind(this.getContainer(),t,(()=>{this.events[t]()}));e.Dom.addClass(this.getContainer(),"--cursor-pointer")}}return this}hexToRgb(t){if(!/^#([\dA-Fa-f]{3}){1,2}$/.test(t)){return t}const e=t.length===4?[t[1],t[1],t[2],t[2],t[3],t[3]]:[...t.slice(1)];const i=parseInt(e.join(""),16);return`${i>>16&255}, ${i>>8&255}, ${i&255}`}setBorderColor(t){if(e.Type.isString(t)){this.borderColor=t;e.Dom.style(this.getContainer(),"--ui-avatar-border-color",this.borderColor)}return this}setBorderInnerColor(t){if(e.Type.isString(t)){this.borderInnerColor=t;e.Dom.style(this.getContainer(),"--ui-avatar-border-inner-color",this.borderInnerColor)}}setBaseColor(t){if(e.Type.isString(t)){this.baseColor=this.hexToRgb(t);e.Dom.style(this.getContainer(),"--ui-avatar-base-color-rgb",this.baseColor)}return this}getUnicId(){if(!this.unicId){this.unicId=`ui-avatar-${Date.now()}-${Math.random().toString(36).slice(2,11)}`}return this.unicId}getDefaultOptions(){return{}}setTitle(t){if(e.Type.isString(t)&&t.trim().length>0){this.title=t;if(this.title.length>0){this.getContainer().setAttribute("title",this.title);const t=/[\p{L}\p{N} ]/u;const e=this.title.split(/[\s,]/).filter((e=>{const i=e.charAt(0);return t.test(i)}));let i="";if(e.length>0){i=e.length>1?e[0].charAt(0)+e[1].charAt(0):i=e[0].charAt(0)}this.setInitials(i.toUpperCase())}}return this}getInitialsNode(){if(!this.node.initials){this.node.initials=e.Tag.render`
				<div class="ui-avatar__text" style="font-size: calc(var(--ui-avatar-size) / 2.6)"></div>
			`}return this.node.initials}setInitials(t){if(this.picPath){return this}if(e.Type.isString(t)){this.getInitialsNode().textContent=t;if(!this.getInitialsNode().parentNode){this.node.initials=e.Tag.render`
					<div class="ui-avatar__text"></div>
				`;e.Dom.append(this.getInitialsNode(),this.getContainer());e.Dom.style(this.getInitialsNode(),"font-size","calc(var(--ui-avatar-size) / 2.6)")}this.getInitialsNode().textContent=t}return this}getSvgElement(t,i){if(e.Type.isString(t)||e.Type.isObject(i)){const e=document.createElementNS("http://www.w3.org/2000/svg",t);Object.keys(i).forEach((t=>{if(Object.prototype.hasOwnProperty.call(i,t)){e.setAttributeNS(null,t,i[t])}}));return e}return null}getMaskNode(){if(!this.node.svgMask){this.node.svgMask=this.getSvgElement("circle",{cx:51,cy:51,r:51,fill:"white"})}return this.node.svgMask}setMask(){const t=this.getSvgElement("mask",{id:`${this.getUnicId()}-${this.constructor.name}`});e.Dom.append(this.getMaskNode(),t);e.Dom.prepend(t,this.getContainer().querySelector("svg"))}getDefaultUserPic(){if(!this.node.svgDefaultUserPic){this.node.svgDefaultUserPic=this.getSvgElement("svg",{width:56,height:64,viewBox:"0 0 28 32",x:23,y:20});this.node.svgDefaultUserPic.innerHTML=`\n\t\t\t\t<path fill="#fff" d="M25.197 29.5091C26.5623 29.0513 27.3107 27.5994 27.0337 26.1625L26.6445 24.143C26.4489 22.8806 25.0093 21.4633 21.7893 20.6307C20.6983 20.3264 19.6613 19.8546 18.7152 19.232C18.5082 19.1138 18.5397 18.0214 18.5397 18.0214L17.5026 17.8636C17.5026 17.7749 17.4139 16.4649 17.4139 16.4649C18.6548 16.048 18.5271 13.5884 18.5271 13.5884C19.3151 14.0255 19.8283 12.0791 19.8283 12.0791C20.7604 9.37488 19.3642 9.53839 19.3642 9.53839C19.6085 7.88753 19.6085 6.20972 19.3642 4.55887C18.7435 -0.917471 9.39785 0.569216 10.506 2.35777C7.77463 1.85466 8.39788 8.06931 8.39788 8.06931L8.99031 9.67863C8.16916 10.2112 8.33041 10.8225 8.51054 11.5053C8.58564 11.7899 8.66401 12.087 8.67586 12.396C8.73309 13.9469 9.68211 13.6255 9.68211 13.6255C9.7406 16.1851 11.0028 16.5184 11.0028 16.5184C11.2399 18.1258 11.0921 17.8523 11.0921 17.8523L9.9689 17.9881C9.9841 18.3536 9.95432 18.7197 9.88022 19.078C9.2276 19.3688 8.82806 19.6003 8.43247 19.8294C8.0275 20.064 7.62666 20.2962 6.9627 20.5873C4.42693 21.6985 1.8838 22.3205 1.39387 24.2663C1.28119 24.7138 1.1185 25.4832 0.962095 26.2968C0.697567 27.673 1.44264 29.0328 2.74873 29.4755C5.93305 30.5548 9.46983 31.1912 13.2024 31.2728H14.843C18.5367 31.192 22.0386 30.5681 25.197 29.5091Z"/>\n\t\t\t`}return this.node.svgDefaultUserPic}getUserPicNode(){if(!this.node.svgUserPic){this.node.svgUserPic=this.getSvgElement("image",{height:102,width:102,mask:`url(#${this.getUnicId()}-${this.constructor.name})`,preserveAspectRatio:"xMidYMid slice"})}return this.node.svgUserPic}setDefaultUserPic(){if(!this.getDefaultUserPic().parentNode){e.Dom.append(this.getDefaultUserPic(),this.getContainer().querySelector("svg"))}e.Dom.addClass(this.getContainer(),"--default-user-pic");e.Dom.remove(this.getInitialsNode());this.node.initials=null;return this}removeDefaultUserPic(){e.Dom.remove(this.getDefaultUserPic());e.Dom.removeClass(this.getContainer(),"--default-user-pic");this.node.svgDefaultUserPic=null;return this}setPic(t){this.setUserPic(t)}removePic(){this.removeUserPic()}setUserPic(t){if(e.Type.isString(t)&&t!==""){this.picPath=t;if(!this.getUserPicNode().parentNode){e.Dom.append(this.getUserPicNode(),this.getContainer().querySelector("svg"))}this.getUserPicNode().setAttributeNS("http://www.w3.org/1999/xlink","href",t);e.Dom.removeClass(this.getContainer(),"--default-user-pic");e.Dom.remove(this.getInitialsNode());this.node.initials=null}return this}removeUserPic(){e.Dom.remove(this.getUserPicNode());this.picPath=null;this.setInitials(this.title);e.Dom.style(this.getContainer(),"--ui-avatar-base-color-rgb",this.baseColor)}setSize(t){if(e.Type.isNumber(t)&&t>0){this.size=t;e.Dom.style(this.getContainer(),"--ui-avatar-size",`${this.size}px`)}return this}getContainer(){if(!this.node.avatar){this.node.avatar=e.Tag.render`
				<div class="ui-avatar --base">
					<svg viewBox="0 0 102 102">
						<circle class="ui-avatar-base" cx="51" cy="51" r="51" />
					</svg>
				</div>
			`}return this.node.avatar}renderTo(t){if(e.Type.isDomNode(t)){e.Dom.append(this.getContainer(),t)}return null}}class a extends i{}class s extends i{getMaskNode(){if(!this.node.svgMask){this.node.svgMask=this.getSvgElement("circle",{cx:51,cy:51,r:42.5,fill:"white"})}return this.node.svgMask}getDefaultUserPic(){if(!this.node.svgDefaultUserPic){this.node.svgDefaultUserPic=this.getSvgElement("svg",{width:56,height:64,viewBox:"0 0 28 32",x:23,y:20});this.node.svgDefaultUserPic.innerHTML=`\n\t\t\t\t<path class="ui-avatar-default-path" d="M25.197 29.5091C26.5623 29.0513 27.3107 27.5994 27.0337 26.1625L26.6445 24.143C26.4489 22.8806 25.0093 21.4633 21.7893 20.6307C20.6983 20.3264 19.6613 19.8546 18.7152 19.232C18.5082 19.1138 18.5397 18.0214 18.5397 18.0214L17.5026 17.8636C17.5026 17.7749 17.4139 16.4649 17.4139 16.4649C18.6548 16.048 18.5271 13.5884 18.5271 13.5884C19.3151 14.0255 19.8283 12.0791 19.8283 12.0791C20.7604 9.37488 19.3642 9.53839 19.3642 9.53839C19.6085 7.88753 19.6085 6.20972 19.3642 4.55887C18.7435 -0.917471 9.39785 0.569216 10.506 2.35777C7.77463 1.85466 8.39788 8.06931 8.39788 8.06931L8.99031 9.67863C8.16916 10.2112 8.33041 10.8225 8.51054 11.5053C8.58564 11.7899 8.66401 12.087 8.67586 12.396C8.73309 13.9469 9.68211 13.6255 9.68211 13.6255C9.7406 16.1851 11.0028 16.5184 11.0028 16.5184C11.2399 18.1258 11.0921 17.8523 11.0921 17.8523L9.9689 17.9881C9.9841 18.3536 9.95432 18.7197 9.88022 19.078C9.2276 19.3688 8.82806 19.6003 8.43247 19.8294C8.0275 20.064 7.62666 20.2962 6.9627 20.5873C4.42693 21.6985 1.8838 22.3205 1.39387 24.2663C1.28119 24.7138 1.1185 25.4832 0.962095 26.2968C0.697567 27.673 1.44264 29.0328 2.74873 29.4755C5.93305 30.5548 9.46983 31.1912 13.2024 31.2728H14.843C18.5367 31.192 22.0386 30.5681 25.197 29.5091Z"/>\n\t\t\t`}return this.node.svgDefaultUserPic}getUserPicNode(){if(!this.node.svgUserpic){this.node.svgUserpic=this.getSvgElement("image",{height:86,width:86,x:8,y:8,mask:`url(#${this.getUnicId()}-${this.constructor.name})`,preserveAspectRatio:"xMidYMid slice"})}return this.node.svgUserpic}getContainer(){if(!this.node.avatar){this.node.avatar=e.Tag.render`
			...
			`}return this.node.avatar}}class d extends s{getContainer(){if(!this.node.avatar){this.node.avatar=e.Tag.render`
			...
			`}return this.node.avatar}}class l extends s{getContainer(){if(!this.node.avatar){this.node.avatar=e.Tag.render`
			...
			`}return this.node.avatar}}class v extends i{getUserPicNode(){if(!this.node.svgUserpic){this.node.svgUserpic=this.getSvgElement("image",{height:102,width:102,mask:`url(#${this.getUnicId()}-${this.constructor.name})`,preserveAspectRatio:"xMidYMid slice"})}return this.node.svgUserpic}getMaskNode(){if(!this.node.svgMask){this.node.svgMask=this.getSvgElement("path",{class:"ui-avatar-mask",d:"M40.4429 2.77436C47.0211 -0.823713 54.979 -0.823711 61.5572 2.77436L88.9207 17.7412C95.9759 21.6001 100.363 29.001 100.363 37.0426V64.9573C100.363 72.9989 95.9759 80.3998 88.9207 84.2588L61.5572 99.2256C54.979 102.824 47.0211 102.824 40.4429 99.2256L13.0794 84.2588C6.02419 80.3998 1.6366 72.9989 1.6366 64.9573V37.0426C1.6366 29.001 6.0242 21.6001 13.0794 17.7412L40.4429 2.77436Z"})}return this.node.svgMask}getContainer(){if(!this.node.avatar){this.node.avatar=e.Tag.render`
			...
			`}return this.node.avatar}}class c extends i{getUserPicNode(){if(!this.node.svgUserpic){this.node.svgUserpic=this.getSvgElement("image",{height:86,width:86,x:8,y:8,mask:`url(#${this.getUnicId()}-${this.constructor.name})`,preserveAspectRatio:"xMidYMid slice"})}return this.node.svgUserpic}getDefaultUserPic(){if(!this.node.svgDefaultUserPic){this.node.svgDefaultUserPic=this.getSvgElement("svg",{width:56,height:64,viewBox:"0 0 28 32",x:23,y:20});this.node.svgDefaultUserPic.innerHTML=`\n\t\t\t\t<path class="ui-avatar-default-path" d="M25.197 29.5091C26.5623 29.0513 27.3107 27.5994 27.0337 26.1625L26.6445 24.143C26.4489 22.8806 25.0093 21.4633 21.7893 20.6307C20.6983 20.3264 19.6613 19.8546 18.7152 19.232C18.5082 19.1138 18.5397 18.0214 18.5397 18.0214L17.5026 17.8636C17.5026 17.7749 17.4139 16.4649 17.4139 16.4649C18.6548 16.048 18.5271 13.5884 18.5271 13.5884C19.3151 14.0255 19.8283 12.0791 19.8283 12.0791C20.7604 9.37488 19.3642 9.53839 19.3642 9.53839C19.6085 7.88753 19.6085 6.20972 19.3642 4.55887C18.7435 -0.917471 9.39785 0.569216 10.506 2.35777C7.77463 1.85466 8.39788 8.06931 8.39788 8.06931L8.99031 9.67863C8.16916 10.2112 8.33041 10.8225 8.51054 11.5053C8.58564 11.7899 8.66401 12.087 8.67586 12.396C8.73309 13.9469 9.68211 13.6255 9.68211 13.6255C9.7406 16.1851 11.0028 16.5184 11.0028 16.5184C11.2399 18.1258 11.0921 17.8523 11.0921 17.8523L9.9689 17.9881C9.9841 18.3536 9.95432 18.7197 9.88022 19.078C9.2276 19.3688 8.82806 19.6003 8.43247 19.8294C8.0275 20.064 7.62666 20.2962 6.9627 20.5873C4.42693 21.6985 1.8838 22.3205 1.39387 24.2663C1.28119 24.7138 1.1185 25.4832 0.962095 26.2968C0.697567 27.673 1.44264 29.0328 2.74873 29.4755C5.93305 30.5548 9.46983 31.1912 13.2024 31.2728H14.843C18.5367 31.192 22.0386 30.5681 25.197 29.5091Z"/>\n\t\t\t`}return this.node.svgDefaultUserPic}getMaskNode(){if(!this.node.svgMask){this.node.svgMask=this.getSvgElement("path",{class:"ui-avatar-mask",d:"M44.2368 10.2019C48.4219 7.93252 53.5781 7.93252 57.7632 10.2019L85.2368 25.0997C89.4219 27.3692 92 31.5632 92 36.1021V65.8977C92 70.4365 89.4219 74.6306 85.2368 76.9L57.7632 91.7978C53.5781 94.0672 48.4219 94.0672 44.2368 91.7978L16.7632 76.9C12.5781 74.6306 10 70.4365 10 65.8977V36.1021C10 31.5632 12.5781 27.3692 16.7632 25.0997L44.2368 10.2019Z"})}return this.node.svgMask}getContainer(){if(!this.node.avatar){this.node.avatar=e.Tag.render`
			...
			`}return this.node.avatar}}class h extends c{getContainer(){if(!this.node.avatar){this.node.avatar=e.Tag.render`
			...
			`}return this.node.avatar}}class C extends c{getContainer(){if(!this.node.avatar){this.node.avatar=e.Tag.render`
			...
			`}return this.node.avatar}}class g extends i{getMaskNode(){if(!this.node.svgMask){this.node.svgMask=this.getSvgElement("path",{class:"ui-avatar-mask",d:"M12 0C5.37258 0 0 5.37258 0 12V90C0 96.6274 5.37258 102 12 102H90C96.6274 102 102 96.6274 102 90V12C102 5.37258 96.6274 0 90 0H12Z"})}return this.node.svgMask}getContainer(){if(!this.node.avatar){this.node.avatar=e.Tag.render`
			...
			`}return this.node.avatar}}class u extends g{getMaskNode(){if(!this.node.svgMask){this.node.svgMask=this.getSvgElement("path",{class:"ui-avatar-mask",d:"M8.47241 14.4724C8.47241 11.1587 11.1587 8.47241 14.4724 8.47241H87.4724C90.7861 8.47241 93.4724 11.1587 93.4724 14.4724V87.4724C93.4724 90.7861 90.7861 93.4724 87.4724 93.4724H14.4724C11.1587 93.4724 8.47241 90.7861 8.47241 87.4724V14.4724Z"})}return this.node.svgMask}getDefaultUserPic(){if(!this.node.svgDefaultUserPic){this.node.svgDefaultUserPic=this.getSvgElement("svg",{width:56,height:64,viewBox:"0 0 28 32",x:23,y:20});this.node.svgDefaultUserPic.innerHTML=`\n\t\t\t\t<path class="ui-avatar-default-path" d="M25.197 29.5091C26.5623 29.0513 27.3107 27.5994 27.0337 26.1625L26.6445 24.143C26.4489 22.8806 25.0093 21.4633 21.7893 20.6307C20.6983 20.3264 19.6613 19.8546 18.7152 19.232C18.5082 19.1138 18.5397 18.0214 18.5397 18.0214L17.5026 17.8636C17.5026 17.7749 17.4139 16.4649 17.4139 16.4649C18.6548 16.048 18.5271 13.5884 18.5271 13.5884C19.3151 14.0255 19.8283 12.0791 19.8283 12.0791C20.7604 9.37488 19.3642 9.53839 19.3642 9.53839C19.6085 7.88753 19.6085 6.20972 19.3642 4.55887C18.7435 -0.917471 9.39785 0.569216 10.506 2.35777C7.77463 1.85466 8.39788 8.06931 8.39788 8.06931L8.99031 9.67863C8.16916 10.2112 8.33041 10.8225 8.51054 11.5053C8.58564 11.7899 8.66401 12.087 8.67586 12.396C8.73309 13.9469 9.68211 13.6255 9.68211 13.6255C9.7406 16.1851 11.0028 16.5184 11.0028 16.5184C11.2399 18.1258 11.0921 17.8523 11.0921 17.8523L9.9689 17.9881C9.9841 18.3536 9.95432 18.7197 9.88022 19.078C9.2276 19.3688 8.82806 19.6003 8.43247 19.8294C8.0275 20.064 7.62666 20.2962 6.9627 20.5873C4.42693 21.6985 1.8838 22.3205 1.39387 24.2663C1.28119 24.7138 1.1185 25.4832 0.962095 26.2968C0.697567 27.673 1.44264 29.0328 2.74873 29.4755C5.93305 30.5548 9.46983 31.1912 13.2024 31.2728H14.843C18.5367 31.192 22.0386 30.5681 25.197 29.5091Z"/>\n\t\t\t`}return this.node.svgDefaultUserPic}getUserPicNode(){if(!this.node.svgUserpic){this.node.svgUserpic=this.getSvgElement("image",{height:86,width:86,x:8,y:8,mask:`url(#${this.getUnicId()}-${this.constructor.name})`,preserveAspectRatio:"xMidYMid slice"})}return this.node.svgUserpic}getContainer(){if(!this.node.avatar){this.node.avatar=e.Tag.render`
			...
			`}return this.node.avatar}}class f extends u{getContainer(){if(!this.node.avatar){this.node.avatar=e.Tag.render`
			...
			`}return this.node.avatar}}class p extends u{getContainer(){if(!this.node.avatar){this.node.avatar=e.Tag.render`
			...
			`}return this.node.avatar}}class A extends i{getDefaultOptions(){return{baseColor:getComputedStyle(document.documentElement).getPropertyValue("--ui-color-accent-main-primary").trim()}}getUserPicNode(){if(!this.node.svgUserpic){this.node.svgUserpic=this.getSvgElement("image",{height:86,width:86,x:8,y:8,mask:`url(#${this.getUnicId()}-${this.constructor.name})`,preserveAspectRatio:"xMidYMid slice"})}return this.node.svgUserpic}getDefaultUserPic(){if(!this.node.svgDefaultUserPic){this.node.svgDefaultUserPic=this.getSvgElement("svg",{width:56,height:64,viewBox:"0 0 28 32",x:23,y:20});this.node.svgDefaultUserPic.innerHTML=`\n\t\t\t\t<path class="ui-avatar-default-path" d="M25.197 29.5091C26.5623 29.0513 27.3107 27.5994 27.0337 26.1625L26.6445 24.143C26.4489 22.8806 25.0093 21.4633 21.7893 20.6307C20.6983 20.3264 19.6613 19.8546 18.7152 19.232C18.5082 19.1138 18.5397 18.0214 18.5397 18.0214L17.5026 17.8636C17.5026 17.7749 17.4139 16.4649 17.4139 16.4649C18.6548 16.048 18.5271 13.5884 18.5271 13.5884C19.3151 14.0255 19.8283 12.0791 19.8283 12.0791C20.7604 9.37488 19.3642 9.53839 19.3642 9.53839C19.6085 7.88753 19.6085 6.20972 19.3642 4.55887C18.7435 -0.917471 9.39785 0.569216 10.506 2.35777C7.77463 1.85466 8.39788 8.06931 8.39788 8.06931L8.99031 9.67863C8.16916 10.2112 8.33041 10.8225 8.51054 11.5053C8.58564 11.7899 8.66401 12.087 8.67586 12.396C8.73309 13.9469 9.68211 13.6255 9.68211 13.6255C9.7406 16.1851 11.0028 16.5184 11.0028 16.5184C11.2399 18.1258 11.0921 17.8523 11.0921 17.8523L9.9689 17.9881C9.9841 18.3536 9.95432 18.7197 9.88022 19.078C9.2276 19.3688 8.82806 19.6003 8.43247 19.8294C8.0275 20.064 7.62666 20.2962 6.9627 20.5873C4.42693 21.6985 1.8838 22.3205 1.39387 24.2663C1.28119 24.7138 1.1185 25.4832 0.962095 26.2968C0.697567 27.673 1.44264 29.0328 2.74873 29.4755C5.93305 30.5548 9.46983 31.1912 13.2024 31.2728H14.843C18.5367 31.192 22.0386 30.5681 25.197 29.5091Z"/>\n\t\t\t`}return this.node.svgDefaultUserPic}getMaskNode(){if(!this.node.svgMask){this.node.svgMask=this.getSvgElement("path",{class:"ui-avatar-mask",d:"M44.2368 10.2019C48.4219 7.93252 53.5781 7.93252 57.7632 10.2019L85.2368 25.0997C89.4219 27.3692 92 31.5632 92 36.1021V65.8977C92 70.4365 89.4219 74.6306 85.2368 76.9L57.7632 91.7978C53.5781 94.0672 48.4219 94.0672 44.2368 91.7978L16.7632 76.9C12.5781 74.6306 10 70.4365 10 65.8977V36.1021C10 31.5632 12.5781 27.3692 16.7632 25.0997L44.2368 10.2019Z"})}return this.node.svgMask}getContainer(){if(!this.node.avatar){this.node.avatar=e.Tag.render`
			...
			`}return this.node.avatar}}t.AvatarBase=i;t.AvatarHexagon=v;t.AvatarHexagonAccent=C;t.AvatarHexagonExtranet=h;t.AvatarHexagonGuest=c;t.AvatarHexagonProject=A;t.AvatarRound=a;t.AvatarRoundAccent=l;t.AvatarRoundBitrixGpt=n;t.AvatarRoundCopilot=r;t.AvatarRoundExtranet=d;t.AvatarRoundGuest=s;t.AvatarRoundMarta=o;t.AvatarSquare=g;t.AvatarSquareAccent=p;t.AvatarSquareExtranet=f;t.AvatarSquareGuest=u})(this.BX.UI=this.BX.UI||{},BX);
