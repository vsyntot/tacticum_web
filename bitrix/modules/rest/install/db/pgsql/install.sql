...
CREATE TABLE b_rest_access_permission (
  ID int GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE UNIQUE INDEX ux_b_rest_access_permission ON b_rest_access_permission (entity_type, access_code, permission);
...
CREATE TABLE b_rest_system_user (
...
CREATE INDEX idx_brsu_resource_id_type ON b_rest_system_user (RESOURCE_ID, RESOURCE_TYPE);