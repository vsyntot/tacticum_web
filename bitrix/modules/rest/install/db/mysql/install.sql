...
CREATE TABLE IF NOT EXISTS b_rest_access_permission
(
	ID INT(11) NOT NULL AUTO_INCREMENT,
	...
	PRIMARY KEY (ID),
	UNIQUE INDEX ux_b_rest_access_permission (ENTITY_TYPE, ACCESS_CODE, PERMISSION)
);
...
CREATE TABLE IF NOT EXISTS b_rest_system_user (
	...
	PRIMARY KEY (ID),
	INDEX idx_brsu_resource_id_resource_type (RESOURCE_ID, RESOURCE_TYPE)
);