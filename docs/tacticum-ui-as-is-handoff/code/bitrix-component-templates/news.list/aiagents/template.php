    ...
    <section class="py-20 bg-gray-50">
        <div class="container mx-auto px-4">
            <div class="text-center mb-16">
                <h2 class="text-3xl md:text-4xl font-bold text-secondary mb-4">Демо-агенты для проверки сценариев</h2>
                <p class="text-lg text-gray-600 max-w-3xl mx-auto">
                    Запустите готовый пример в Telegram, чтобы оценить формат диалога и понять, какие данные,
                    правила и интеграции понадобятся вашему production-боту.
                </p>
            </div>
                ...
                foreach( $arResult["ITEMS"] as $arItem ){
                    ...
                    <div class="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300">
                        <div class="h-80 overflow-hidden">
                            <img src="<?=$agentImage?>" alt="<?=$agentName?>" loading="lazy" decoding="async" class="w-full h-full object-cover object-top"/>
                        </div>
                        <div class="p-6">
                            ...
                            <a href="<?=$agentLink?>" target="_blank" rel="noopener" class="text-primary font-medium flex items-center gap-1 hover:gap-2 transition-all">Открыть демо-агента <i class="ri-arrow-right-line"></i></a>
                        </div>
                    </div>
                <?}?>
            </div>
