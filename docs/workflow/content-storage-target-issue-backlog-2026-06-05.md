...
| CST-WP-07 | fallback-retirement deployed / rechecked | ready for wave 2 planning | P1 | Architect + Backend + Content + Frontend + QA | `CSG-007`, `CSG-008`, `CSG-012` | Structured page-content model |
| CST-WP-08 | wave 1 source switch and smoke passed | wave-2-deferred | P1/P2 | Backend + Frontend + Content + QA | `CSG-007`, `CSG-008` | Static section migration wave 1 and wave 2 |
