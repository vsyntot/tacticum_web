...
- `offer-taxonomy-presets-owner-approval-2026-06-07.approved.json` — owner-approved `/offer/` taxonomy/preset model for `OFFER-TAX-WP-04`; validates without `--allow-draft`, but still does not approve iblock apply or runtime source switch.
