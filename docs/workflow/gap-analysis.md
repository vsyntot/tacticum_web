...
| PG-008 | open | P2 | Full Feature | Layout consistency | Повторяемые CTA/form секции всё ещё копируются между публичными страницами | `index.php`, `calculator/index.php`, `price/index.php`, `contacts/index.php`, `about/index.php`, `services/index.php` | UX-правки форм и CTA приходится размножать вручную, высокий риск расхождений | Выделить CTA/form section в include или Bitrix component после visual baseline |
...
| TG-017 | in-progress | P1 | Full Feature | JS-owned markup | Specialist modal markup перенесён из JS в Bitrix component template; крупные repeated CTA blocks ещё требуют componentization | `news.list/price/template.php`, `news.list/price/script.js`, `modal.js`, public pages | Заказ специалистов стал ближе к Bitrix component pattern; дубли CTA остаются источником drift | Следующий спринт: вынести repeated CTA/form section |
