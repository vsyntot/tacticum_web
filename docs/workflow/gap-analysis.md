...
07.06.2026 `/about/` trust-storyline local slice advanced `ABOUT-WP-03`, `ABOUT-WP-05` and `ABOUT-WP-06`: hero/company copy, stat cards, technology/stack copy, final CTA, footer start-work anchor, wave2 seed, context-aware `/about/` page-content normalization and source/rendered guards now frame the page around corporate AI launch responsibility without adding proof claims. Local PHP lint, `product:content:safety:check`, `seo:check`, `bitrix:check` and `git diff --check` passed. Keep `ABOUT-002`, `ABOUT-003`, `ABOUT-006` and `ABOUT-008` in-progress until production deploy/cache clear/rendered evidence and owner review exist; `ABOUT-004`, `ABOUT-005` and `ABOUT-009` remain open/blocked.
