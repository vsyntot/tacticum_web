...
07.06.2026 local implementation started `ABOUT-WP-01`, `ABOUT-WP-02`, `ABOUT-WP-05`, `ABOUT-WP-06` and `ABOUT-WP-08`: source partials, footer menu, page-content seed, `PublicCopyNormalizer`, source hygiene and rendered hygiene self-tests were updated. Keep these ABOUT gaps non-closed until production deploy/cache clear and rendered `/about/` evidence pass.
...
If future work starts from the 07.06 `/about/` challenge, convert local `ABOUT-*` observations into tracker issues using `about-page-ux-content-challenge-issue-backlog-2026-06-07.md`. Start with `ABOUT-WP-01` and `ABOUT-WP-02` if the goal is production hygiene: stale timeline, duplicate IDs, missing anchors and misleading footer anchors. Do not rewrite trust claims, team/person data, public proof, footer SEO semantics, form IDs/payloads or page-content/fallback ownership without the owner gates listed in the roadmap and backlog. Do not fix `2025 / Сегодня` by simply changing the year; separate historical milestones from current operating focus.
