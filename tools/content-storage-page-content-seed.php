    ...
    private function waveOneSections(): array
    {
        return [
            ...
            [
                ...
                'blocks' => [
                    $this->block('platform-team', 'product_card', 'Команда Platform', 'Архитектор, backend, data/RAG, integration, QA и DevOps для платформенной предпроектной оценки или пилота.', ['icon' => 'ri-stack-line', 'href' => '/platform/', 'meta' => 'product=platform']),
                    $this->block('agents-pilot', 'product_card', 'Пилот Agents', 'Аналитик, prompt/RAG, backend, integration и QA для запуска ассистента в одном подразделении.', ['icon' => 'ri-robot-2-line', 'href' => '/agents/', 'meta' => 'product=agents']),
                    ...
                    $this->block('forum-launch', 'product_card', 'Запуск Forum', 'CX-аналитик, сценарист, backend, integration, QA и PM для первого потока обращений.', ['icon' => 'ri-customer-service-2-line', 'href' => '/forum/', 'meta' => 'product=forum']),
                ],
            ],
            [
                'page' => '/contacts/',
