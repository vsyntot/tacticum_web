    ...
    private function waveTwoSections(): array
    {
        return [
            ...
            [
                ...
                'title' => 'Почему продуктовая модель требует сильной команды внедрения',
                'text' => 'Корпоративный AI-продукт требует архитектуры, данных, интеграций, безопасности, эксплуатации, команды и понятного пути от пилота до рабочей эксплуатации.',
                'blocks' => [
                    ...
                    $this->block('team', 'routing_card', 'Команда', 'Подбираем роли под этап: аналитика, серверная разработка, работа с данными и поиском по базе знаний, QA, DevOps, PM и интеграции.', ['icon' => 'ri-team-line', 'href' => '/price/']),
                    $this->block('estimate', 'routing_card', 'Оценка', 'Сначала фиксируем границы пилота, риски и следующий шаг, затем уточняем бюджет и план запуска.', ['icon' => 'ri-calculator-line', 'href' => '/calculator/']),
                ],
            ],
            [
                'page' => '/about/',
