...
$labelAfterControl = $isProjectDiscussion;
...
$formClass = $isGlassVariant
    ? 'tacticum-lead-cta-form tacticum-lead-cta-form--select-labels-static bg-white/10 backdrop-blur-sm rounded-xl p-6' . ($isProjectDiscussion ? '' : ' mb-6')
...
$selectLabelClass = $isGlassVariant
    ? 'block text-sm font-medium text-white/70 mb-2'
    : $labelClass;
$selectControlClass = $isGlassVariant
    ? 'w-full bg-white/5 border border-white/20 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-white/30'
    : $controlClass;
...
$messagePlaceholder = $isGlassVariant ? ' ' : $arResult['MESSAGE_PLACEHOLDER'];
