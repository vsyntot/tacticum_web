            ...
            <?foreach( $arResult["ITEMS"] as $arItem ){
                ...
                <div class="bg-white rounded-xl p-6 shadow-sm">
                    <div class="flex justify-between items-start mb-4">
                        <div>
                            <h4 class="text-lg font-bold text-secondary"><?=$arItem["NAME"]?></h4>
                            <p class="text-gray-500"><?=$arItem["PROPERTIES"]["LOCATION"]["VALUE"]?> / <?=$arItem["PROPERTIES"]["TYPE"]["VALUE"]?></p>
                        </div>
                        <span class="bg-primary/10 text-primary text-xs font-medium px-3 py-1 rounded-full"><?=$arItem["PROPERTIES"]["TIME"]["VALUE"]?></span>
                    </div>
                    <p class="text-gray-600 mb-4"><?=$arItem["PREVIEW_TEXT"]?></p>
