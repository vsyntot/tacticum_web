                ...
                <section class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <label class="block">
                            ...
                            <input type="text" id="orderName" name="name" required class="w-full border border-gray-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50">
                        </label>
                        <label class="block">
                            <span class="block text-sm font-medium text-gray-600 mb-2">Email</span>
                            <input type="email" id="orderEmail" name="email" required class="w-full border border-gray-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50">
                        </label>
                        <label class="block">
                            <span class="block text-sm font-medium text-gray-600 mb-2">Телефон</span>
                            <input type="tel" id="orderPhone" name="phone" required class="w-full border border-gray-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50">
                        </label>
                        <label class="block">
                            <span class="block text-sm font-medium text-gray-600 mb-2">Компания</span>
                            <input type="text" id="orderCompany" name="company" class="w-full border border-gray-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50">
                        </label>
                    </div>
                </section>
                ...
                <section class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <label class="block">
                            ...
                            <input type="date" id="orderStartDate" name="startDate" class="w-full border border-gray-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50">
                        </label>
                        <label class="block">
                            <span class="block text-sm font-medium text-gray-600 mb-2">Срок работы</span>
                            <select id="orderDuration" name="duration" class="w-full border border-gray-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 appearance-none bg-white">
                        ...
                        <label class="block">
                            ...
                            <select id="orderWorkload" name="workload" class="w-full border border-gray-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50 appearance-none bg-white">
                    ...
                    <label class="hidden" data-price-end-date-wrap>
                        ...
                        <input type="date" id="orderEndDate" name="endDate" data-price-end-date class="w-full border border-gray-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50">
                    </label>
                </section>

                <label class="block">
                    <span class="block text-sm font-medium text-gray-600 mb-2">Какую задачу должна решить команда</span>
                    <textarea id="orderDescription" name="message" required rows="4" class="w-full border border-gray-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-primary/50"></textarea>
                </label>
